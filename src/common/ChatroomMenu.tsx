...
export type ChatroomMenuRef = BottomSheetMenuRef;
export type ChatroomMenuProps = Omit<
  BottomSheetMenuProps,
  'title' | 'initItems'
> & {
  addMarqueeTask: () => void;
...
export const ChatroomMenu = React.forwardRef<
  ChatroomMenuRef,
  ChatroomMenuProps
>(function (
  props: ChatroomMenuProps,
  ref?: React.ForwardedRef<ChatroomMenuRef>
) {
  const {
    onRequestModalClose,
    addGiftEffectTask,
